...
class ESP01_MQTT:
    ...
    def setup(self, ssid, password, mqtt_server, topic_sub, topic_pub1,topic_pub2,topic_pub3,topic_pub4,topic_sub1,topic_sub2,topic_sub3,topic_sub4 ,ready):
        reset = 'RESET'
        ...
        utime.sleep(0.01)
        self.send_cmd_wait_resp(topic_sub1)
        utime.sleep(0.01)
        self.send_cmd_wait_resp(topic_sub2)
        utime.sleep(0.01)
        self.send_cmd_wait_resp(topic_sub3)
        utime.sleep(0.01)
        #開關用
        self.send_cmd_wait_resp(topic_sub4)
        utime.sleep(0.01)
    ...
    def publish_data(self, value1, value2, value3, value4):
        self.wait_resp()
        y1 = str(value1)
        y2 = str(value2)
        y3 = str(value3)
        ...
        self.send_cmd_wait_resp(f'PB4+{y4}')
...
if __name__ == '__main__':
    ...
    esp01_mqtt.setup(
        ...
        topic_pub4='TOPIC3+MQTT/5555/5555',
        topic_sub1='TOPIC1+MQTT/6666/6666',
        topic_sub2='TOPIC2+MQTT/7777/7777',
        topic_sub3='TOPIC3+MQTT/8888/8888',
        topic_sub4='TOPIC3+MQTT/9999/9999',
        ready='ready'
    )
    ...
    while True:
        print('Loop MQTT2.py')
        esp01_mqtt.publish_data(value1_to_send, value2_to_send, value3_to_send, value3_to_send)
        utime.sleep(1)
