...
class ESP01_MQTT:
    ...
    def setup(self, ssid, password, mqtt_server, channel, apikey, topic_sub, topic_pub1,topic_pub2,topic_pub3, ready):
        reset = 'RESET'
    ...
    def publish_data(self, value1, value2, value3):
        ...
        self.send_cmd_wait_resp(f'PB1+ {y1} hpa,')
        self.send_cmd_wait_resp(f'PB2+ {y2} L/H,')
