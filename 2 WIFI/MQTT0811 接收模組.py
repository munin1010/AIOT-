...
class ESP01_MQTT:
    ...
    def setup(self, ssid, password, mqtt_server, topic_sub,ready):
        reset = 'RESET'
    ...
    def publish_data(self, value1, value2, value3):
        ...
        y3 = str(value3)
        #y4 = str(value4)
        self.send_cmd_wait_resp(f'PB1+{y1}+{y2}+{y3}')
...
if __name__ == '__main__':
    ...
    while True:
        a=ESP01_MQTT.subscribe_data(value)
        print(a)
