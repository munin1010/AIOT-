...
class ESP01_MQTT:
    ...
    def setup(self, ssid, password, mqtt_server, topic_sub, topic_pub1,topic_pub2,topic_pub3,topic_pub4,ready):
        reset = 'RESET'
...
if __name__ == '__main__':
    ...
    esp01_mqtt.setup(
        ...
        topic_pub4='TOPIC4+MQTT/5555/5555',
        ready='ready'
    )
    ...
    while True:
        print('Loop MQTT2.py')
        esp01_mqtt.publish_data(value1_to_send, value2_to_send, value3_to_send, value4_to_send)
        utime.sleep(1)
